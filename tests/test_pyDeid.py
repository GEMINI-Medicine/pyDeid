...
# class TestCorrectOutputFindOnlyCsv(unittest.TestCase):
...
#    pyDeid(original_file = filepath + '/10_test.csv', 
#       note_varname = 'note_text', 
#       encounter_id_varname = 'genc_id',
#       note_id_varname = 'note_id',
#       regex_find = True,
#       regex_replace = False,
#       mll_replace = True,
#       mll_file = filepath + '/mll_10_test.csv'
#       )
...
class TestCorrectOutputMllAndFindCsv(unittest.TestCase):
   pyDeid(original_file = os.path.join(filepath, 'test.csv'), 
      note_varname = 'note_text', 
      encounter_id_varname = 'genc_id',
      regex_replace = False,
      mll_file = os.path.join(filepath, 'mll_test.csv')
      )
